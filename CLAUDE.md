...
`subaction` (operation) routing (19 actions / 177 subactions). Call it as
...
| action | subactions |
|--------|-----------|
| **system** (24) | overview, array, network, registration, variables, metrics, services, display, display_details, config, online, owner, settings, server, server_details, servers, network_access_urls, flash, ups_devices, ups_device, ups_config, server_time, timezones, network_interfaces |
...
| **user** (1) | me |
| **live** (17) | cpu, memory, cpu_telemetry, array_state, parity_progress, ups_status, notifications_overview, notifications_warnings, notification_feed, log_tail, owner, server_status, display, docker_container_stats, temperature, network, plugin_install_updates |
