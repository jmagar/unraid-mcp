...
- `unraid` — the only tool, with `action` + `subaction` routing (19 actions, 170 subactions). The Markdown reference and WebSocket diagnostics are the `help` and `subscriptions` actions of this tool.
