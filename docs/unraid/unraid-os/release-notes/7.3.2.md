Version 7.3.2 2026-07-08 | Unraid Docs
...
## Upgrading[​](#upgrading)
For step-by-step instructions, see [Updating Unraid](https:///unraid-os/updating-unraid/). Questions about your [license](/unraid-os/troubleshooting/licensing-faq/#license-types--features)?
## Known issues[​](#known-issues)
* No new release-specific known issues are noted. For issues inherited from prior releases, see the [Unraid OS 7.3.1](/unraid-os/release-notes/7.3.1/) release notes.
## Notes[​](#notes)
...
* No new rollback limitations are noted for this release. Before rolling back, review the [Unraid OS 7.3.1](/unraid-os/release-notes/7.3.1/) release notes.
## BREAKING CHANGES[​](#breaking-changes)
* None.
## Changes vs. Unraid OS 7.3.1[​](#changes-vs-unraid-os-731)
### Security[​](#security)
...
CONFIG\_USB\_AUTOSUSPEND\_DELAY=-1
## Base distro updates[​](#base-distro-updates)
### Added packages (3)[​](#added-packages-3)
* libcbor: version 0.14.0
* libfido2: version 1.17.0
* libmaxminddb: version 1.13.3
### Updated packages (73)[​](#updated-packages-73)
* aaa\_libraries: version 15.1-50 -\> 15.1-51
...
* json-c: version 0.18\_20240915 -\> 0.19
...
* net-tools: version 20181103\_0eebece-3 -\> 20181103\_0eebece-5 (CVE-2025-46836)
