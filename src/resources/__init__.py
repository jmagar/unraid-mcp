...
from src.resources.disks import register_disk_resources
...
def register_all_resources(server, unraid_client):
    ...
    register_notification_resources(server, unraid_client)
    register_disk_resources(server, unraid_client)
